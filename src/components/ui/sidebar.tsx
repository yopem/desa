...
export const SidebarGroupLabel = ({
  ...
  asChild = false,
  ...props
}: React.ComponentProps<typeof ark.div> & { asChild?: boolean }) => {
  return (
    <ark.div
      asChild={asChild}
...
export const SidebarGroupAction = ({
  ...
  asChild = false,
  ...props
}: React.ComponentProps<typeof ark.button> & { asChild?: boolean }) => {
  return (
    <ark.button
      asChild={asChild}
...
export const SidebarMenuButton = ({
  ...
  const button = (
    <ark.button
      ...
      className={cn(
        "text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground active:bg-sidebar-accent active:text-sidebar-accent-foreground [data-[active=true]:bg-sidebar-accent data-[active=true]:text-sidebar-accent-foreground flex cursor-pointer items-center gap-2 overflow-hidden rounded-md px-2 text-sm outline-hidden focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
